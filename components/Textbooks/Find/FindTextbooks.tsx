...
import ShopByCourse from "./ShopByCourse"
...
export default function FindTextbooks(){
    ...
    return(
        ...
        <div className="mx-auto  max-w-7xl w-full  sm:px-6 lg:px-8 ">
          <div className="relative isolate overflow-hidden bg-marshall-950 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32 grid grid-flow-row place-items-center overflow-y-visible">
