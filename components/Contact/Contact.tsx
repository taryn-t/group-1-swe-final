        ...
        <form onSubmit={handleSubmit} className="px-6 pt-20 pb-24 sm:pb-32 lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full border border-gray-400 rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-marshall-600"
                  />
                </div>
              </div>
              <div>
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="rounded-md bg-marshall-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-marshall-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-marshall-600"
              >
                Send message
              </button>
            </div>
