...
interface Props{
   selected: DepartmentDocument | any
   setSelected: ({}:DepartmentDocument | any) => void;
}

export default function DeptSelect({selected, setSelected}:Props) {
  const [options, setOptions] = useState<Array<DepartmentDocument>>()
